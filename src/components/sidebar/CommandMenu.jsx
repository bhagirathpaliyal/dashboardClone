...
import { FiEye, FiLink, FiLogIn, FiLogOut, FiPhone, FiPlus } from "react-icons/fi";
  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white rounded-lg shadow-xl border-stone-300 border overflow-hidden w-full mx-w-lg mx-auto mt-12"
      >
        <Command.Input
          value={value}
        ...
        <Command.List className="p-3">
          <Command.Empty>No results found for.  <span className="text-violet-500">"{value}"</span></Command.Empty>
